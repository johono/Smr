...
public class Alunos2 extends javax.swing.JFrame {
    ...
    private void Atualiza_Cidade(String cod){
        try {
            ...
            Logger.getLogger(Alunos2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    try{
      ...
      if (rs.next()) {
        rs.previous();
        while (rs.next()) {
          this.cbNome.addItem(rs.getString("NOM_ALUNO"));
        }
      }
      this.cbNome.addItem("");
      ...
      if ("0".equals(Rotinas.Parametros.getCod_aluno())){
        ...
        if (rs != null){
          ...
          this.jLogradouro.setText(rs.getString("ENDERECO"));
      ...
      Logger.getLogger(Alunos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jDt_Vig = new javax.swing.JFormattedTextField();
        ...
        jDigito = new javax.swing.JTextField();
        ...
        btPesq_Av.setNextFocusableComponent(cbNome);
        ...
        cbNome.setNextFocusableComponent(jPesquisa);
        ...
        jNome.setNextFocusableComponent(jLogradouro);

        jLogradouro.setNextFocusableComponent(jFone);
        ...
        try {
            jDt_Vig.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jPesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btPesq))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jNome)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jLogradouro, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jEndereco, javax.swing.GroupLayout.DEFAULT_SIZE, 265, Short.MAX_VALUE))
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jOperacao, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jConta, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jDigito, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jDigito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel22))
    ...
    private void btPesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesqActionPerformed
        ...
        if("".equals(this.jPesquisa.getText())){
            rs = this.taluno.Ler_Aluno(this.cbNome.getSelectedItem().toString(), 1);
        }else{
      ...
      if (!"".equals(this.cbUnd.getSelectedItem().toString())) {
        if (!"".equals(this.cbEmpresa.getSelectedItem().toString())) {
          if (!"".equals(this.cbCurso.getSelectedItem().toString())) {
            if (!"".equals(this.cbCidade.getSelectedItem().toString())) {
                      ...
                      if (!"".equals(this.jRg.getText())) {
                        if (!"".equals(this.jNome.getText())) {
                          if (this.cons.isCPF(this.cons.desmascaraCpf(this.jCpf.getText()))) {
                            ...
                            String endereco = this.jLogradouro.getText();
                            ...
                            String curso = this.cbCurso.getSelectedItem().toString();
                            this.taluno.Grava_Altera_Aluno(cod, nome, endereco, fone, rg, cpf, obs, valor, valor_ext, pai, mae, data, data_fim, cidade, und, empresa, curso, teste);
                            Atualiza_Aluno();
                          } else {
                            JOptionPane.showMessageDialog(null, "CPF INVÁLIDO.", "Informacao", 1);
                          }
                        } else {
                          JOptionPane.showMessageDialog(null, "PREENCHA O CAMPO NOME.", "Informacao", 1);
                        }
                      } else {
                        JOptionPane.showMessageDialog(null, "PREENCHA O CAMPO RG.", "Informacao", 1);
                      }
                    } else {
                      JOptionPane.showMessageDialog(null, "PREENCHA O CAMPO CPF.", "Informacao", 1);
                    }
                  } else {
                    JOptionPane.showMessageDialog(null, "PREENCHA O CAMPO Vigência.", "Informacao", 1);
                  }
                } else {
                  JOptionPane.showMessageDialog(null, "ALUNO JÁ CADASTRADO.", "Informacao", 1);
                }
              } else {
                JOptionPane.showMessageDialog(null, "PREENCHA O CAMPO VALOR.", "Informacao", 1);
              }
            } else {
              JOptionPane.showMessageDialog(null, "UMA CIDADE DEVE SER SELECIONADA.", "Informacao", 1);
            }
          } else {
            JOptionPane.showMessageDialog(null, "UM CURSO DEVE SER SELECIONADO.", "Informacao", 1);
          }
        } else {
          JOptionPane.showMessageDialog(null, "UMA EMPRESA DEVE SER SELECIONADA.", "Informacao", 1);
        }
      } else {
        JOptionPane.showMessageDialog(null, "UMA UNIDADE DE ENSINO DEVE SER SELECIONADA.", "Informacao", 1);
      }
    } else {
    ...
    private javax.swing.JTextField jDigito;
    private javax.swing.JLabel jDt_Cad;
    private javax.swing.JFormattedTextField jDt_Vig;
